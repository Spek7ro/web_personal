    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-[30px]">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="mst">Software Engineering</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* textarea */}
          ...
          {/* info */}
          <div
            className="flex-1 items-center xl:justify-end order-1 
              ...
              {info.map((item, index) => {
                return (
                  <li key={index} className="flex items-center gap-6">
                    ...
                    bg-[#27272c] text-accent rounded-full flex items-center 
                    justify-center"
                    >
