...
const services = [
  {
    ...
    description: "Web development services for clients and projects",
    href: "",
  },
  {
    num: "02",
    title: "Backend Development",
    description: "Backend development microservices and APIs",
    href: "",
  },
  {
    num: "03",
        ...
        >
          {services.map((service, index) => {
            return (
              <div
                key={index}
                className="felx-1 flex flex-col justify-center gap-6 group"
              >
                {/*  top */}
